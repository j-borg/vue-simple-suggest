...
var VueSimpleSuggest = {
  ...
  computed: {
    ...
    hoveredIndex() {
      return this.suggestions.findIndex(
        (el) =>
          this.hovered &&
          this.valueProperty(this.hovered) == this.valueProperty(el)
      );
    },
    textLength() {
      return (
  ...
  methods: {
    ...
    miscSlotsAreEmpty() {
      const slots = ["misc-item-above", "misc-item-below"].map(
        (s) => this.$scopedSlots[s]
      );
      ...
      return _invoke(
        function () {
          if (
            ...
            _this.minLength <= _this.textLength
          ) {
            ...
            function () {
              return _invokeIgnored(function () {
                if (_this2.canSend) {
                  ...
                  return _await(_this2.getSuggestions(_this2.text), function (
                    newList
                  ) {
